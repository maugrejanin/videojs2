index.controller('indexCtrl', function($scope, $http, $window, $location, $rootScope, $timeout, $mdDialog) {

    // function init(){
    //     Diplomat.init($http, $mdDialog, $window, $location);
    // }

    function isMobile() {
	    var check = false;
        function vaiquevai (a){console.log("a");
        ...
        vaiquevai(navigator.userAgent||navigator.vendor||window.opera);
        return check;
    }
    function init(window, videojs) {
